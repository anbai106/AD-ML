            ...
            for dwi_map in dwi_maps:
                for i in tissue_type:
                    for j in threshold:
                        for k in fwhm:
                            for l in top_k:
                                if feature_selection_nested == False and feature_selection_non_nested == False:
                                ...
                                if not path.exists(classification_dir):
                                    ...
                                    if feature_selection_nested == False and feature_selection_non_nested == False:
                                        ...
                                        wf = DWI_VB_RepHoldOut_DualSVM(caps_directory, subjects_visits_tsv, diagnoses_tsv, dwi_map,
                                                                       ...
                                                                       test_size=test_size,
                                                                       grid_search_folds=grid_search_folds, splits_indices=splits_indices)
                                    elif feature_selection_non_nested == True and feature_selection_nested == False:
                                        print 'Original data classification with non-nested feature selection procedures!!!'
                                    ...
                                    elif feature_selection_non_nested == False and feature_selection_nested == True:
                                        print 'Original data classification with nested feature selection procedures!!!'
